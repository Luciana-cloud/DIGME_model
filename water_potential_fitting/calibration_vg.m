...
% x    = Data(96:101,4); % hyide.de Water pontential [Bar]
% x    = Data(103:108,4); % lygra.no Water pontential [Bar]
% x    = Data(109:114,4); % nyngan.au Water pontential [Bar]
% x    = Data(114:119,4); % passogavia.it Water pontential [Bar]
...
x    = Data(138:141,4); % skotsvar.no Water pontential [Bar]
...
q(1)   = Data(138,5); % skotsvar.no Saturated soil moisture content [-]*
...
% WC_obs      = Data(96:101,2); % hyide.de Water pontential (mean) [-]
% WC_sd       = Data(96:101,3); % hyide.de Water pontential (sd) [-]
...
% WC_obs      = Data(114:119,2); % passogavia.it Water pontential (mean) [-]
% WC_sd       = Data(114:119,3); % passogavia.it Water pontential (sd) [-]
...
WC_obs      = Data(138:141,2); % skotsvar.no Water pontential (mean) [-]
WC_sd       = Data(138:141,3); % skotsvar.no Water pontential (sd) [-]
