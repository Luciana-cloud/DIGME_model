...
% x    = Data1(96:101,4); % hyide.de Water pontential [Bar]
% x    = Data1(102:107,4); % lygra.no Water pontential [Bar]
% x    = Data(109:114,4); % nyngan.au Water pontential [Bar]
% x    = Data1(114:119,4); % passogavia.it Water pontential [Bar]
...
% x    = Data1(138:141,4); % skotsvar.no Water pontential [Bar]
...
% WC_obs      = Data1(96:101,2); % hyide.de Water pontential (mean) [-]
% WC_sd       = Data1(96:101,3); % hyide.de Water pontential (sd) [-]
% WC_obs      = Data1(102:107,2); % lygra.no Water pontential (mean) [-]
% WC_sd       = Data1(102:107,3); % lygra.no Water pontential (sd) [-]
% WC_obs      = Data(109:114,2); % nyngan.au Water pontential (mean) [-]
% WC_sd       = Data(109:114,3); % nyngan.au Water pontential (sd) [-]
% WC_obs      = Data1(114:119,2); % passogavia.it Water pontential (mean) [-]
% WC_sd       = Data1(114:119,3); % passogavia.it Water pontential (sd) [-]
...
% WC_obs      = Data1(138:141,2); % skotsvar.no Water pontential (mean) [-]
% WC_sd       = Data1(138:141,3); % skotsvar.no Water pontential (sd) [-]
